...
const EN={
  ...
  'Serwer odłączony':'Server disconnected',
  '1 dzień':'1 day',
  '{n} dni':'{n} days',
  '{n} godz.':'{n}h',
  'reset: {d}':'reset: {d}',
  'Gra nie udostępnia czasu resetu — aplikacja wykrywa go sama, obserwując tablicę.':'The game does not publish reset times — the app detects them itself by watching the board.',
  'Ostatni wykryty reset (±{h} godz.). Kolejny da się oszacować po następnym.':'Last detected reset (±{h}h). The next one can be estimated after one more.',
  'Szacowane z {n} zaobserwowanych resetów, co ~{p} (±{h} godz.).':'Estimated from {n} observed resets, about every {p} (±{h}h).',
  'Ten serwer jest chwilowo odłączony od API':'This server is temporarily disconnected from the API',
  'To awaria po stronie empire-api, nie Twojego połączenia. Spróbuj później lub wybierz inny serwer.':'This is an empire-api outage, not your connection. Try again later or pick another server.',
  ...
  'Tłumaczenia i eventy...':'Translations and events...',
